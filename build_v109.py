#!/usr/bin/env python3
"""build_v109: build .exe + wrap into friend-distribution .zip.

v1.0.9: drops raw .exe in favor of .zip to avoid Windows Defender /
SmartScreen false positive that PyInstaller onefile triggers when
distributed as a bare .exe on GitHub Releases.
"""
